...
function AnimatedStat({ value, label }: { value: string; label: string }) {
  ...
  return (
    <div ref={ref} className="flex flex-col">
      ...
      <span className="text-sm text-gray-500 uppercase tracking-wider mt-1">{label}</span>
    </div>
  );
}
    ...
    <section id="about" className="py-24 bg-gray-100">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="flex lg:flex-col gap-8 lg:gap-10 lg:pl-8 lg:border-l border-gray-300 pt-8 lg:pt-0 border-t lg:border-t-0">
            {stats.map((stat) => (
